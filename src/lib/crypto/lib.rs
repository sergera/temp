...
#[derive(Clone, PartialEq, Eq, Hash)]
pub struct PublicExpontent {
    pub content: Vec<u8>,
}
impl PublicExpontent {
    pub fn hex(&self) -> String {
        hex::encode(&self.content)
    }
}
impl From<Vec<u8>> for PublicExpontent {
    fn from(content: Vec<u8>) -> Self {
        Self { content }
    }
}
#[derive(Clone, PartialEq, Eq, Hash)]
pub struct PrivateExpontent {
    pub content: Vec<u8>,
}
impl From<Vec<u8>> for PrivateExpontent {
    fn from(content: Vec<u8>) -> Self {
        Self { content }
    }
}
